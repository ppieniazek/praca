...
from business.models import EmploymentPeriod, Worker, WorkLog
...
class TestWorkerModel:
    ...
    def test_worker_creation(self):
        ...
        worker = Worker.objects.create(
            organization=org, first_name="Jan", last_name="Kowalski", hourly_rate=30
        )
    ...
    def test_worker_ordering(self):
        ...
        Worker.objects.create(
            organization=org, first_name="Zofia", last_name="Abacka", hourly_rate=25
        )
        Worker.objects.create(
            organization=org, first_name="Adam", last_name="Babacki", hourly_rate=25
        )
